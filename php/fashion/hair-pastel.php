<?php
$thisPortrait= "HairPastel";
$thisLang="en";
$thispageDesc="Hair in Pastel Colors";
$thisAuthor="Bram de Haan";
$thisOrg="Atelier Bram de Haan";
$thisType="pastel";
$thisPage="hair-pastel";
...
imgObj.src = "<?php if ($rootUrl!="") echo $rootUrl; ?>assets/img/png/hair-pastel_32x32.png";
</script>

<script src="<?php if ($rootUrl!="") echo $rootUrl; ?>assets/js/libs/d3.v3.min.js"></script>
<script src="<?php if ($rootUrl!="") echo $rootUrl; ?>assets/js/convert-to-svg_circle.js"></script>
<script>
